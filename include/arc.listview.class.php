...
class ListView
{
    ...
    function GetPageListST($list_len,$listitem="index,end,pre,next,pageno")
    {
       ...
       $maininfo = "<span class=\"pageinfo\">共 <strong>{$totalpage}</strong>页<strong>".$this->TotalResult."</strong>条</span>\r\n";
        ...
        if($this->PageNo != 1)
        {
            $prepage.="<a class='xf-l' href='".str_replace("{page}",$prepagenum,$tnamerule)."'></a>";
           // $indexpage="<li><a href='".str_replace("{page}",1,$tnamerule)."'>首页</a></li>\r\n";
        }
        else
        {
         $indexpage="<a class='xf-l'></a>";
        }

        //下一页,未页的链接
        if($this->PageNo!=$totalpage && $totalpage>1)
        {
            $nextpage.="<a class='xf-r' href='".str_replace("{page}",$nextpagenum,$tnamerule)."'></a>";
          //  $endpage="<li><a href='".str_replace("{page}",$totalpage,$tnamerule)."'>末页</a></li>\r\n";
        }
        else
        {
           $endpage="<a class='xf-r'></a>";
        }
    ...
    function GetPageListDM($list_len,$listitem="index,end,pre,next,pageno")
    {
        ...
        if($this->PageNo != 1)
        {
            $prepage.="<a class='xf-l' href='".$purl."PageNo=$prepagenum'></a>";
        ...
        if($this->PageNo!=$totalpage && $totalpage>1)
        {
            $nextpage.="<a class='xf-r' href='".$purl."PageNo=$nextpagenum'></a>";
